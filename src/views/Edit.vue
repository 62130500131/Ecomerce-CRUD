<template>
  <div class="add">
    ...
    <base-card>
              <h2 class="heading border-green-800">
                Edit Product
              </h2>
            <br/>
 ...
 export default {
    ...
    data(){
        return {
            ...
            enteredName : this.oldName, errorName : false,
            enteredBrand : this.oldBrand, errorBrand : false,
            enteredDescription : this.oldDescription, errorDescription : false,
            enteredPrice : this.oldPrice, errorPrice : false,
            enteredColor : this.oldColor, errorColor : false,
            id : this.oldId,
            newSurvey: {
                name : '',
                brand : '',
    ...
    methods: {
      ...
      console.log(`color value: ${this.enteredColor}`)
       ...
       this.EditSurvey(this.newSurvey)
       alert(`Succes to edit id ${this.id}`)
       }
     

        },
    async EditSurvey(newSurvey) {
      try {
